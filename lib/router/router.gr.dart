...
abstract class $RootRouter extends _i59.RootStackRouter {
  ...
  final Map<String, _i59.PageFactory> pagesMap = {
    ...
    ScanRouteWrapper.name: (routeData) {
      return _i59.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: _i59.WrappedRoute(child: const _i10.ScanPageWrapper()),
      );
    },
    ...
    D3PRPCRouteWrapper.name: (routeData) {
      return _i59.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: _i59.WrappedRoute(child: const _i16.D3PRPCPageWrapper()),
      );
    },
    ...
    ExplorerRouteWrapper.name: (routeData) {
      return _i59.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: _i59.WrappedRoute(child: const _i18.ExplorerPageWrapper()),
      );
    },
    ...
    WalletRouteWrapper.name: (routeData) {
      return _i59.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: _i59.WrappedRoute(child: const _i26.WalletPageWrapper()),
      );
    },
    ...
    CreateAccountRouteWrapper.name: (routeData) {
      return _i59.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: _i59.WrappedRoute(child: const _i32.CreateAccountPageWrapper()),
      );
    },
    ...
    CreateAssetRouteWrapper.name: (routeData) {
      return _i59.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: _i59.WrappedRoute(child: const _i54.CreateAssetPageWrapper()),
      );
    },
    ...
    MintAssetRoute.name: (routeData) {
      return _i59.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: const _i57.MintAssetPage(),
      );
    },
