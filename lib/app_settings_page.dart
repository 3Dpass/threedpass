...
class AppSettings extends StatefulWidget {
  AppSettings ({Key key, this.title, this.home}) : super(key: key);
          ...
          SettingsGroup(
            ...
            children: <Widget>[
              DropDownSettingsTile<int>(
                ...
                selected: 3,
                onChange: (value) {
                  debugPrint('key-dropdown-algo: $value');
                },
              ),

              DropDownSettingsTile<int>(
                title: 'Grid size',
                settingKey: 'key-dropdown-size',
                values: <int, String>{
                  6: '6x6',
                  7: '7x7',
                  8: '8x8',
                },
                selected: 7, // widget.home.grid_size,
                onChange: (value) {
                  debugPrint('key-dropdown-size: $value');
                  widget.home.grid_size = value;
              ...
              DropDownSettingsTile<int>(
                title: 'N sections',
                settingKey: 'key-dropdown-sections',
                values: <int, String>{
                  1: '1',
                  2: '2',
                  3: '3',
                ...
                selected: 10, // widget.home.n_sections,
                onChange: (value) {
                  debugPrint('key-dropdown-email-view: $value');
                  widget.home.n_sections = value;
...
//              SliderSettingsTile(
//                title: 'Complexity',
//                settingKey: 'key-slider-complexity',
//                defaultValue: 20,
//                min: 0,
//                max: 100,
//                step: 5,
