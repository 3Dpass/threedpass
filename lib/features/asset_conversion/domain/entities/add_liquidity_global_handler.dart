...
class AddLiquidityGlobalHandler
    extends PrimitiveEventLogsHandler<NotificationAddLiquidity> {
  const AddLiquidityGlobalHandler({
  ...
  @override
  NotificationAddLiquidity customCopyWith(
    final NotificationAddLiquidity initialN,
