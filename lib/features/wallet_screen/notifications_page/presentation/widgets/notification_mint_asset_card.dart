...
class NotificationMintAssetCard extends StatelessWidget {
  final NotificationMintAsset notificationDTO;

  const NotificationMintAssetCard(this.notificationDTO, {super.key});
