...
class Utils {
   ...
   */
  static Vector3 normalVector3(
    final Vector3 v1,
    final Vector3 v2,
    final Vector3 v3,
  ) {
    final Vector3 s1 = Vector3.copy(v2);
    s1.sub(v1);
    final Vector3 s3 = Vector3.copy(v2);
    s3.sub(v3);
   ...
   */
  static double scalarMultiplication(final Vector3 v1, final Vector3 v2) {
   ...
   */
  static double degreeToRadian(final double degree) {
   ...
   */
  static double zIndex(final Vector3 p1, final Vector3 p2, final Vector3 p3) {
